...
function inquireList() {
    ...
    connection.query("SELECT * FROM products",
        function (err, res) {
            ...
            console.log("Number" + "\t" + "Product" + "\t" + "Department" + "\t" +"Item Cost" + "\t" +"Available" );
            for (var i = 0; i < res.length; i++) {
                console.log(res[i].item_ID + "\t" + res[i].product_name + "\t" + res[i].department_name + "\t" + res[i].cost_to_customer + "\t" + res[i].stock_quantity);
                //console.log("\t" );
